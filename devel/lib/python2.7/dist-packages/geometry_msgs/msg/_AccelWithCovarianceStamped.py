...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_struct_6d.pack(_x.accel.accel.linear.x, _x.accel.accel.linear.y, _x.accel.accel.linear.z, _x.accel.accel.angular.x, _x.accel.accel.angular.y, _x.accel.accel.angular.z))
      buff.write(_struct_36d.pack(*self.accel.covariance))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.accel.accel.linear.x, _x.accel.accel.linear.y, _x.accel.accel.linear.z, _x.accel.accel.angular.x, _x.accel.accel.angular.y, _x.accel.accel.angular.z,) = _struct_6d.unpack(str[start:end])
      start = end
      end += 288
      self.accel.covariance = _struct_36d.unpack(str[start:end])
      return self
