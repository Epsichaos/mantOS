...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'diagnostic_updater' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pi/manta_ws/install_isolated/${idir}'.  Ask the maintainer 'Austin Hendrix <namniart@gmail.com>, Brice Rebsamen <brice.rebsamen@gmail.com>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/pi/manta_ws/install_isolated/lib;/home/pi/manta_ws/devel_isolated/diagnostic_analysis/lib;/home/pi/manta_ws/devel_isolated/diagnostic_msgs/lib;/home/pi/manta_ws/devel_isolated/common_msgs/lib;/home/pi/manta_ws/devel_isolated/actionlib_msgs/lib;/opt/ros/indigo/lib)
