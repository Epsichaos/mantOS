...
if("FALSE" STREQUAL "TRUE")
  set(pluginlib_SOURCE_PREFIX /home/pi/manta_ws/src/pluginlib)
  set(pluginlib_DEVEL_PREFIX /home/pi/manta_ws/devel_isolated/pluginlib)
  ...
  set(pluginlib_INSTALL_PREFIX /home/pi/manta_ws/install_isolated)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'pluginlib' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Mikael Arguedas <mikael@osrfoundation.org>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'pluginlib' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pi/manta_ws/install_isolated/${idir}'.  Ask the maintainer 'Mikael Arguedas <mikael@osrfoundation.org>' to fix it.")
    endif()
    _list_append_unique(pluginlib_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "/usr/lib/arm-linux-gnueabihf/libboost_filesystem.so;/usr/lib/arm-linux-gnueabihf/libboost_system.so;/usr/lib/arm-linux-gnueabihf/libtinyxml.so")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${pluginlib_dep}_FOUND)
      find_package(${pluginlib_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${pluginlib_dep} REQUIRED ${depend_list})
  endif()
