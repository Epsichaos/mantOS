...
message(STATUS "manta: 2 messages, 0 services")

set(MSG_I_FLAGS "-Imanta:/home/pi/manta_ws/src/manta/msg;-Istd_msgs:/opt/ros/indigo/share/std_msgs/cmake/../msg;-Igeometry_msgs:/home/pi/manta_ws/src/common_msgs/geometry_msgs/msg")
...
get_filename_component(_filename "/home/pi/manta_ws/src/manta/msg/Imu.msg" NAME_WE)
add_custom_target(_manta_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "manta" "/home/pi/manta_ws/src/manta/msg/Imu.msg" "geometry_msgs/Vector3:std_msgs/Header:geometry_msgs/Quaternion"
)

get_filename_component(_filename "/home/pi/manta_ws/src/manta/msg/NavSatFix.msg" NAME_WE)
add_custom_target(_manta_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "manta" "/home/pi/manta_ws/src/manta/msg/NavSatFix.msg" "std_msgs/Header"
)
...
add_dependencies(manta_generate_messages_cpp geometry_msgs_generate_messages_cpp)
...
add_dependencies(manta_generate_messages_lisp geometry_msgs_generate_messages_lisp)

if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/manta)
  install(CODE "execute_process(COMMAND \"/usr/bin/python\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/manta\")")
  # install generated code
  install(
...
add_dependencies(manta_generate_messages_py geometry_msgs_generate_messages_py)
