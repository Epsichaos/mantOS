...
if("TRUE" STREQUAL "TRUE")
  set(urg_c_SOURCE_PREFIX /home/pi/manta_ws/src/urg_c)
  set(urg_c_DEVEL_PREFIX /home/pi/manta_ws/devel_isolated/urg_c)
  set(urg_c_INSTALL_PREFIX "")
  set(urg_c_PREFIX ${urg_c_DEVEL_PREFIX})
else()
  set(urg_c_SOURCE_PREFIX "")
  set(urg_c_DEVEL_PREFIX "")
  set(urg_c_INSTALL_PREFIX /home/pi/manta_ws/install_isolated)
...
if(NOT "/home/pi/manta_ws/src/urg_c/current/include " STREQUAL " ")
  set(urg_c_INCLUDE_DIRS "")
  set(_include_dirs "/home/pi/manta_ws/src/urg_c/current/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'urg_c' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Chad Rockey <chadrockey@gmail.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'urg_c' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pi/manta_ws/src/urg_c/${idir}'.  Ask the maintainer 'Chad Rockey <chadrockey@gmail.com>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${urg_c_dep}_FOUND)
      find_package(${urg_c_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${urg_c_dep} REQUIRED ${depend_list})
  endif()
