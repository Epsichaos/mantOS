...
if("TRUE" STREQUAL "TRUE")
  set(diagnostic_updater_SOURCE_PREFIX /home/pi/manta_ws/src/diagnostics/diagnostic_updater)
  set(diagnostic_updater_DEVEL_PREFIX /home/pi/manta_ws/devel_isolated/diagnostic_updater)
  ...
  set(diagnostic_updater_INSTALL_PREFIX /home/pi/manta_ws/install_isolated)
...
if(NOT "/home/pi/manta_ws/src/diagnostics/diagnostic_updater/include " STREQUAL " ")
  set(diagnostic_updater_INCLUDE_DIRS "")
  set(_include_dirs "/home/pi/manta_ws/src/diagnostics/diagnostic_updater/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'diagnostic_updater' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Austin Hendrix <namniart@gmail.com>, Brice Rebsamen <brice.rebsamen@gmail.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'diagnostic_updater' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pi/manta_ws/src/diagnostics/diagnostic_updater/${idir}'.  Ask the maintainer 'Austin Hendrix <namniart@gmail.com>, Brice Rebsamen <brice.rebsamen@gmail.com>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/pi/manta_ws/devel_isolated/diagnostic_updater/lib;/home/pi/manta_ws/devel_isolated/diagnostic_analysis/lib;/home/pi/manta_ws/devel_isolated/diagnostic_msgs/lib;/home/pi/manta_ws/devel_isolated/common_msgs/lib;/home/pi/manta_ws/devel_isolated/actionlib_msgs/lib;/opt/ros/indigo/lib)
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${diagnostic_updater_dep}_FOUND)
      find_package(${diagnostic_updater_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${diagnostic_updater_dep} REQUIRED ${depend_list})
  endif()
