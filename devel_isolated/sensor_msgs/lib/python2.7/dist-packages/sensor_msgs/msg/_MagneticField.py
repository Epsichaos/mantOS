...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.magnetic_field_covariance is None:
        self.magnetic_field_covariance = [0.,0.,0.,0.,0.,0.,0.,0.,0.]
    else:
      self.header = std_msgs.msg.Header()
      self.magnetic_field = geometry_msgs.msg.Vector3()
      self.magnetic_field_covariance = [0.,0.,0.,0.,0.,0.,0.,0.,0.]
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_struct_3d.pack(_x.magnetic_field.x, _x.magnetic_field.y, _x.magnetic_field.z))
      buff.write(_struct_9d.pack(*self.magnetic_field_covariance))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.magnetic_field.x, _x.magnetic_field.y, _x.magnetic_field.z,) = _struct_3d.unpack(str[start:end])
      start = end
      end += 72
      self.magnetic_field_covariance = _struct_9d.unpack(str[start:end])
      return self
