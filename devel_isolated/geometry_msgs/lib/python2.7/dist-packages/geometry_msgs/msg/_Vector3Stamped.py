...
"""autogenerated by genpy from geometry_msgs/Vector3Stamped.msg. Do not edit."""
import sys
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_struct_3d.pack(_x.vector.x, _x.vector.y, _x.vector.z))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.vector.x, _x.vector.y, _x.vector.z,) = _struct_3d.unpack(str[start:end])
      return self
