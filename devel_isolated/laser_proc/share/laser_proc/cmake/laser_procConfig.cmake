...
if("TRUE" STREQUAL "TRUE")
  set(laser_proc_SOURCE_PREFIX /home/pi/manta_ws/src/laser_proc)
  set(laser_proc_DEVEL_PREFIX /home/pi/manta_ws/devel_isolated/laser_proc)
  ...
  set(laser_proc_INSTALL_PREFIX /home/pi/manta_ws/install_isolated)
...
if(NOT "/home/pi/manta_ws/src/laser_proc/include " STREQUAL " ")
  set(laser_proc_INCLUDE_DIRS "")
  set(_include_dirs "/home/pi/manta_ws/src/laser_proc/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'laser_proc' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Chad Rockey <chadrockey@willowgarage.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'laser_proc' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pi/manta_ws/src/laser_proc/${idir}'.  Ask the maintainer 'Chad Rockey <chadrockey@willowgarage.com>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${laser_proc_dep}_FOUND)
      find_package(${laser_proc_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${laser_proc_dep} REQUIRED ${depend_list})
  endif()
