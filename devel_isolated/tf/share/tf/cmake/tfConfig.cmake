...
if("TRUE" STREQUAL "TRUE")
  set(tf_SOURCE_PREFIX /home/pi/manta_ws/src/geometry/tf)
  set(tf_DEVEL_PREFIX /home/pi/manta_ws/devel_isolated/tf)
  set(tf_INSTALL_PREFIX "")
  set(tf_PREFIX ${tf_DEVEL_PREFIX})
else()
  set(tf_SOURCE_PREFIX "")
  set(tf_DEVEL_PREFIX "")
  set(tf_INSTALL_PREFIX /home/pi/manta_ws/install_isolated)
...
if(NOT "/home/pi/manta_ws/devel_isolated/tf/include;/home/pi/manta_ws/src/geometry/tf/include " STREQUAL " ")
  set(tf_INCLUDE_DIRS "")
  set(_include_dirs "/home/pi/manta_ws/devel_isolated/tf/include;/home/pi/manta_ws/src/geometry/tf/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'tf' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Tully Foote <tfoote@osrfoundation.org>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'tf' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pi/manta_ws/src/geometry/tf/${idir}'.  Ask the maintainer 'Tully Foote <tfoote@osrfoundation.org>' to fix it.")
    endif()
...
set(tf_EXPORTED_TARGETS "tf_generate_messages_cpp;tf_generate_messages_lisp;tf_generate_messages_py")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${tf_dep}_FOUND)
      find_package(${tf_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${tf_dep} REQUIRED ${depend_list})
  endif()
